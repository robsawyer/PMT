...
<div class="projects index">
	...
	<ul class="details">
		...
		<?php 
			...
			if($totalCount > 0){
				echo "<span style='color:red; font-weight:normal !important;'>Upcoming projects:</span> <span style='color:red;font-weight:bold;'>$totalCount</span>";
			}else{
	...
	<tr<?php echo $class; ?>>
		...
		<td width="20%"><?php 
			...
			?>&nbsp;</td>
		<td width="5%" title="Total units"><?php 
