<div class="projects index">
	<h2><?php __('In-house Projects');?></h2>
	<h3><?php __('Details');?></h3>
	<ul class="details">
		<li>Total projects: <span class="number-count"><?php echo count($projects); ?></span></li>
	</ul>
	<ul class="details">
		<li><?php echo $this->Html->link(__("Standard media projects",true),array('action'=>'inhouse','standard'));?>: <span class="number-count"><?php echo count($standardMedia); ?></span></li>
		<li><?php echo $this->Html->link(__("Rich media projects",true),array('action'=>'inhouse','rich'));?>: <span class="number-count"><?php echo count($richMedia); ?></span></li>
	</ul>
